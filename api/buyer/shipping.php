...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if($buy->validate_params($_GET['shipping'])){
        $buy->shipping = $_GET['shipping'];
    }
    else{
        echo json_encode(array('success' => 0, 'message' => 'shipping is required!'));
        die();
    }


    $buy->shipping($buy->seller_id, $buy->image, $buy->buyer_id, $buy->shipping);
    echo "Success = 1";
