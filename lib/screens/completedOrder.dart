...
import '../widgets/completedOrderItem.dart';
...
class CompletedOrder extends StatefulWidget {
  ...
  const CompletedOrder({Key? key, required this.receivedMap}) : super(key: key);
...
class _CompletedOrderState extends State<CompletedOrder> {
  ...
  void getCompletedOrders(int sellerId, String sellerName) {
    ServerHandler().getDeliveredProducts(sellerId, sellerName).then((value) => {
      setState(() {
        print("Value of Completed Orders $value");
        _buyModel = value;
      })
    });
  ...
  Widget build(BuildContext context) {
    if (_firstExec == true) {
      getCompletedOrders(int.parse(widget.receivedMap['id']), widget.receivedMap['name']);
      _firstExec = false;
    }
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) => CompletedOrderItem(
