...
class ShippedOrderItem extends StatefulWidget {
  ...
  @override
  State<ShippedOrderItem> createState() => _ShippedOrderItemState();
}

class _ShippedOrderItemState extends State<ShippedOrderItem> {
        ...
        Column(
          children: [
            ...
            Padding(
              ...
              child: IconButton(onPressed: () => print("Contact"), icon: Icon(Icons.message, size: 50, color: Color(0xff4A777A),)),
            )
          ],
        ),
